class Constanta {
  ...
  static const REPORT_BOOK =
      'http://sibi.cloudapp.web.id/api/laporan/create.php';
  static const UPDATE_DOWNLOAD_BOOK = 'http://sibi.cloudapp.web.id/api/download/create.php';
